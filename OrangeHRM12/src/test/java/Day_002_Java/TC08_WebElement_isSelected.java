...
WebDriver driver;	
		...
		public void login_test() throws Exception 
		{
			try
			{
				...
				Boolean str_male = driver.findElement(By.xpath("//*[@id='Content']/div[1]/blockquote[1]/form/input[1]")).isSelected();
					...
					System.out.println("Sunday check box is not  selected");
					}
				
				
			Assert.assertSame(str_male, true);
