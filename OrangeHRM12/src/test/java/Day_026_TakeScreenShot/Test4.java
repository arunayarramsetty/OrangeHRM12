...
public class Test4 {
	...
	// FileUtils.copyFile(scrFile, new File("C:\\ScreenShot1.jpg"));
	 ...
	 FileUtils.copyFile(SrcFile1, new File("C:\\TC023_Login\\TC1_ScreenShot1.jpg"));
