...
public class TC03_Implicit_waitpractice {
  ...
  public void Login_Test() throws Exception
	{
	  ...
	  TC03_Implicit_waitpractice.OpenOrangeHRM();
	  TC03_Implicit_waitpractice.Login();
	  TC03_Implicit_waitpractice.Addnatialities();
	  TC03_Implicit_waitpractice.Logout1();
	  TC03_Implicit_waitpractice.closebrowser();
  }
  ...
  public static void Addnatialities() throws Exception
	{
		...
		findElement(By.id("nationality_name")).sendKeys("Indian77");
