...
public class TC01_Explicit_Waitpractice {
  ...
  public void Login_Test() throws Exception{
	  ...
	  String str= "TC01_Login";
		...
		TC01_Explicit_Waitpractice.OpenOrangeHRM();
		TC01_Explicit_Waitpractice.Login();
		TC01_Explicit_Waitpractice.Addnatialities();
		TC01_Explicit_Waitpractice.Logout();
		TC01_Explicit_Waitpractice.closebrowser();
}
