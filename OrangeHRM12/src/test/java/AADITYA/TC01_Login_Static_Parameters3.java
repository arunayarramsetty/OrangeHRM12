...
public class TC01_Login_Static_Parameters3 {
	...
	public void loginTest(String Browser,String TestURL,String UserName,String Password,String Nationality_text) throws Exception //Step3
	{
		
		
		//TC01_Login_Static_Parameters3.OpenChromeBroswer();
		...
		TC01_Login_Static_Parameters3.OpenOrangeHRM(TestURL);
		TC01_Login_Static_Parameters3.Login(UserName,Password); //step2
		TC01_Login_Static_Parameters3.AddNationalities(Nationality_text);//stp2
		TC01_Login_Static_Parameters3.CloseBrowser();
	}
